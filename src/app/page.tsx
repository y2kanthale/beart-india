...
import { ArrowRight, Target, Briefcase, Server, Heart, Users, FileText, Mail, Phone, MessageSquare, CircleCheckBig, HandCoins, CodeXml, Award, TrendingUp, BrainCircuit } from 'lucide-react';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://beartindia.com/og-image.png', 
        width: 1200,
        height: 630,
   ...
   twitter: {
    ...
    images: ['https://beartindia.com/twitter-image.png'], 
  },
};
          ...
          <div className="container mx-auto px-4 sm:px-6 md:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 mb-8 sm:mb-12">
              ...
              <div className="text-center animate-in fade-in zoom-in-95 delay-300 duration-500 p-2">
                <BrainCircuit className="h-10 w-10 sm:h-12 sm:w-12 text-primary mx-auto mb-3 sm:mb-4" />
