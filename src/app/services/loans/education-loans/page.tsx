...
import { GraduationCap, ArrowRight, CheckCircle, Banknote, Globe, FileText, Calculator, Search, Users } from "lucide-react"; 
import Link from "next/link";
import { LeadGenerationForm } from "@/components/forms/lead-generation-form";
import type { Metadata } from 'next';
import Image from "next/image";
import { EmiCalculatorDialog } from "@/components/calculators/emi-calculator-dialog";
        ...
        <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none mx-auto text-muted-foreground space-y-6 mb-12">
          ...
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground !mt-10 !mb-4">Our Education Loan Services</h2>
            <ul className="space-y-2 sm:space-y-3 list-none">
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-4">
                <EmiCalculatorDialog>
                  <Button variant="outline" className="p-4 border rounded-lg bg-secondary transition-all duration-300 ease-in-out hover:shadow-lg hover:bg-accent animate-in zoom-in-95 duration-500 delay-800 w-full h-full flex flex-col items-start justify-start text-left text-sm sm:text-base">
          ...
          <ul className="space-y-2 sm:space-y-3 list-none">
                ...
                <li className="flex items-start gap-2 animate-in fade-in slide-in-from-right-12 duration-500 delay-500">
                    <Globe className="h-4 w-4 sm:h-5 sm:w-5 text-primary mt-1 shrink-0" /> {/* Changed icon for variety */}
