                ...
                <SipCalculatorDialog>
                  <Button variant="outline" className="p-4 border rounded-lg bg-secondary transition-all duration-300 ease-in-out hover:shadow-lg hover:bg-accent w-full h-full flex flex-col items-start justify-start text-left text-sm sm:text-base">
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground overflow-visible whitespace-normal break-words">Estimate potential returns on your systematic investments.</p>
                      <span className="text-[hsl(var(--accent-investment))] font-medium text-xs sm:text-sm mt-auto self-start">Open Calculator <ArrowRight className="inline-block ml-1 h-3 w-3 sm:h-4 sm:w-4" /></span>
                  </Button>
                </SipCalculatorDialog>
              </div>
